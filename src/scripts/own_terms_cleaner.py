...
INDV_URL = "https://purl.brain-bican.org/ontology/CCN20250428/"

CURRENT_DIR = Path(__file__).resolve().parent
OWN_CLASSES_TSV = (CURRENT_DIR.parent / "patterns" / "data" / "default" / "CCN20250428_class_base.tsv").resolve()
INDIVIDUALS_TSV = (CURRENT_DIR.parent / "templates" / "CCN20250428.tsv").resolve()
