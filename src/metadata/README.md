 ...
 * [bgo.yml](bgo.yml)
     * Determines how your purl.obolibrary.org/obo/bgo/ redirects will be handled
     ...
     * Paste in the contents of [bgo.yml](bgo.yml)
 ...
 * [bgo.md](bgo.md)
     ...
     * Paste in the contents of [bgo.md](bgo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
